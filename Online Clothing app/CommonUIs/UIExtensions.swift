...
enum robotoserif: String{
    case regular = "RobotoSerif-Regular"
    case medium = "RobotoSerif-Medium.ttf"
    case semibold = "RobotoSerif-SemiBold"
    case bold = "RobotoSerif-Bold"
}

extension Font {
    
    static func customfont(_ font: robotoserif, fontSize: CGFloat) -> Font {
